...
function startAnalysis() {
    if ($('#ChineseLevel').val() === '' || $('#EnglishLevel').val() === '' || $('#MathLevel').val() === '' || $('#ProfessionOneLevel').val() === '' || $('#ProfessionTwoLevel').val() === '') {
        alert('請輸入所有科目的成績。');
        return;
    }
