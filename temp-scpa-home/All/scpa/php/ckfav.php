...
$sql2=sprintf("SELECT * FROM `recfav` WHERE `UserID`='%s' and `SchoolName`='%s' and `SchoolDepName`='%s' and `Type`='%s'",mysql_real_escape_string($user),mysql_real_escape_string($school),mysql_real_escape_string($department),mysql_real_escape_string($Type));
