...
$sql1='';
if($NP=='0'){
    $sql1=sprintf('SELECT * FROM scorecollate JOIN onlyone ON scorecollate.SchoolName=onlyone.SchoolName where scorecollate.CatchScores >=%d+2 and scorecollate.CatchScores <=%d+3 and scorecollate.CatchScores >= 0 and scorecollate.Type=\'%s\' AND scorecollate.Area LIKE \'%%%s%%\' order by scorecollate.CatchScores desc',mysql_real_escape_string($data),mysql_real_escape_string($data),mysql_real_escape_string($Type),mysql_real_escape_string($Area));
}else{
    if($NP=='1'){
        $sql1=sprintf('SELECT * FROM scorecollate JOIN onlyone ON scorecollate.SchoolName=onlyone.SchoolName where scorecollate.CatchScores >=%d+2 and scorecollate.CatchScores <=%d+3 and scorecollate.CatchScores >= 0 and scorecollate.Type=\'%s\' AND scorecollate.Area LIKE \'%%%s%%\' AND onlyone.NP IN(\'1\',\'4\',\'5\') order by scorecollate.CatchScores desc',mysql_real_escape_string($data),mysql_real_escape_string($data),mysql_real_escape_string($Type),mysql_real_escape_string($Area));
    }else{
        if($NP=='2'){
            $sql1=sprintf('SELECT * FROM scorecollate JOIN onlyone ON scorecollate.SchoolName=onlyone.SchoolName where scorecollate.CatchScores >=%d+2 and scorecollate.CatchScores <=%d+3 and scorecollate.CatchScores >= 0 and scorecollate.Type=\'%s\' AND scorecollate.Area LIKE \'%%%s%%\' AND onlyone.NP IN(\'2\',\'3\',\'6\') order by scorecollate.CatchScores desc',mysql_real_escape_string($data),mysql_real_escape_string($data),mysql_real_escape_string($Type),mysql_real_escape_string($Area));
        }
    }
}
